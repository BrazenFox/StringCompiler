package com.stringcompiler.loaders;
...
import com.stringcompiler.compilers.StringCompiler;

public class StringClassLoader extends ClassLoader {
    private static final StringClassLoader __instance
            = new StringClassLoader();

    private static final Logger logger =
            Logger.getLogger(StringClassLoader.class.getName());
    ...
    public static StringClassLoader getInstance() {
        return __instance;
    }
